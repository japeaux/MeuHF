...
export const ConfirmacaoScreen = ({ navigation , route}) => {
  ...
  const [checkeddin, setCheckeddin] = useState(false);
  const [checkedcre, setCheckedcre] = useState(false);
  const [checkedde, setCheckedde] = useState(false);
  const [checkedSODEXO, setCheckedSODEXO] = useState(false);
  ...
  const [checkedCPF, setCheckedCPF] = React.useState(false);
    ...
    pedido.valoroferta = (parseFloat(preco)+7).toFixed(2)
...
//    pedido.cpfnanota = cpfnanota
    pedido.valortotal = (parseFloat(preco)+7).toFixed(2)
...
// 
  ...
  const goNext = () => {
    ...
    if(checkedde){
      pedido.metodopagamento = 'Cartão de débito'
    
    }
    if(checkedSODEXO){
      pedido.metodopagamento = 'SODEXO'
    }
    if(checkedPIX){
    ...
    padding: 20,  marginLeft: 35,
        ...
        <View style={styles.row}>
          ...
          <Checkbox
            ...
            status={checkeddin ? 'checked' : 'unchecked'}
            onPress={() => {
              MP('Dinheiro');
            }}
          />       
    ...
    margin: 5, fontStyle: 'italic', }}>Troco para? (caso n deixe em branco)</Text>
        ...
        <View style={styles.row}>
          ...
          <Checkbox
            ...
            status={checkedcre ? 'checked' : 'unchecked'}
            onPress={() => {
              MP('crédito')
            }}
      ...
      <View style={styles.row}>
          ...
          <Checkbox
            label="Esse é um checkbox"
            labelStyle={{ color: '#000', fontSize: 16 }}
            status={checkedde ? 'checked' : 'unchecked'}
            onPress={() => {
              MP('débito')
            }}
          ...
          <Text  style={{fontSize: 15, alignItems:'center', color:'#4b4b4b'}}>Cartão de débito</Text>
        </View>
       ...
       <View style={styles.row}>
          ...
          <Checkbox
            label="Esse é um checkbox"
            labelStyle={{ color: '#000', fontSize: 16 }}
            status={checkedSODEXO ? 'checked' : 'unchecked'}
            onPress={() => {
              MP('SODEXO');
            }}
          ...
          <Text  style={{fontSize: 15, alignItems:'center', color:'#4b4b4b'}}>SODEXO</Text>
        </View>
        ...
        <View style={styles.row}>
          ...
          <Checkbox
            label="Esse é um checkbox"
            labelStyle={{ color: '#000', fontSize: 16 }}
            status={checkedPIX ? 'checked' : 'unchecked'}
            onPress={() => {
              MP('PIX');
            }}
          ...
          <Text  style={{fontSize: 15, alignItems:'center', color:'#4b4b4b'}}>PIX</Text>
        </View>

           {checkedPIX ? (
          <View>
              <Text  style={{fontSize: 12, alignItems:'center', color:'#4b4b4b', fontStyle: 'italic', marginLeft: 55,
                marginRight: 55,marginBottom:20}} >*Pagamentos via PIX (CNPJ 28.057.481/0001-90) deverão ter o comprovante enviado pelo Whatsapp (41 9516-0693)</Text>
        ...
        <View style={styles.row}>
          ...
          />
            ...
            <Text  style={{fontSize: 15, alignItems:'center'}}>Não</Text>
              ...
              <Text  style={{fontSize: 12, alignItems:'center', color:'#4b4b4b', fontStyle: 'italic', marginLeft: 55,
                marginRight: 55,}} >*As entregas serão feitas de Segunda à Sexta, das 08:30 às 16h. Pedidos feitos fora desse período serão entregues no próximo horário disponível de entrega.</Text>
