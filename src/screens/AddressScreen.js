...
export const AddressScreen = ({ navigation , route}) => {
  ...
  const { geoloc } = React.useContext(AuthContext);
  ...
  console.log(numeroendereco)
   if(!numeroendereco){
       Alert.alert(
         ...
         geoloc(userData).then(response =>{
            console.log(response)
            console.log(response.lat)
            if(response.lat){
              var lat2 = -25.4342
              var lng2 = -49.2714
              var radlat1 = Math.PI * response.lat/180
              var radlat2 = Math.PI * lat2/180
              var theta = response.lng-lng2
              ...
              if(dist<21){
                ...
                Alert.alert(
                  "Muito distante",
                  'Não conseguimos entregar onde você esta',
                  [
              ...
              // distance(response.lat, response.lng).then(response =>{
              //   console.log(response)
              //   if(response){
              //     console.log(response)
              //   }
