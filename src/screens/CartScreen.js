  ...
  return (
    <View>
      ...
      <View style={{alignItems: 'center'}}>
        <Text style={{fontSize: 12,   
            ...
            marginRight: 35,
            margin: 10,
            alignItems: 'center',}}>Valor carrinho: R$ {preco}</Text>
      </View>
    ...
    <View style={{alignItems: 'center'}}>
        <Text style={{fontSize: 12,   
            ...
            marginRight: 35,
            margin: 10,
            alignItems: 'center',}}>Taxa de entrega: R$ 7,00</Text>
      </View>
      <View style={{alignItems: 'center'}}>
        <Text style={{fontSize: 15,   
            ...
            marginRight: 35,
            margin: 10,
            alignItems: 'center',}}>VALOR TOTAL: R$ {precototal}</Text>
      </View>
